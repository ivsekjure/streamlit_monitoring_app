create or replace view SEVEN_DAY_AVERAGE_TREND(
	START_DATE,
	WAREHOUSE_NAME,
	CREDITS_USED_DATE_WH,
	CREDITS_USED_7_DAY_AVG,
   ...
   WITH CTE_DATE_WH AS(
     ...
     SELECT START_DATE::DATE as START_DATE
           ,WAREHOUSE_NAME
           ,CREDITS_USED_DATE_WH as CREDITS_USED_DATE_WH
       ...
       FROM CTE_DATE_WH
     -- QUALIFY CREDITS_USED_DATE_WH > 80  // Minimum N=100 credits
